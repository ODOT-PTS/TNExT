    ...
    MAKE_PROVIDER = function(layer, type, minZoom, maxZoom) {
        return {
            ...
            "attribution":  [
                ...
                'Census & shapes data &copy; <a href="http://www.census.gov">US Census Bureau</a> 2010'
            ].join("")
        };
    },
    PROVIDERS =  {
...
for (var i = 0; i < odbl.length; i++) {
    ...
    PROVIDERS[key].attribution = [
        'Tiles by <a href="http://stamen.com/">Stamen Design</a>, ',
        'Map by <a href="http://openstreetmap.org/">OpenStreetMap</a>, ',
        'Census & shapes by &copy; <a href="http://www.census.gov">US Census Bureau</a> 2010'
    ].join("");
}
