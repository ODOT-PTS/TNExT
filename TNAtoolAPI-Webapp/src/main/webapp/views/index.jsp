...
<script type="text/javascript"
	src="resources/js/jquery-ui.multidatespicker.js"></script>
...
<script type="text/javascript"
	src="vendors/jstree-v.pre1.0/jquery.jstree.js"></script>
<script type="text/javascript"
	src="vendors/DataTables/js/jquery.dataTables.js"></script>
<script type="text/javascript"
	src="vendors/DataTables/js/dataTables.tableTools.js"></script>
...
<script type="text/javascript"
	src="vendors/leaflet-0.7/search/Control.Geocoder.js"></script>
<script type="text/javascript"
	src="vendors/leaflet-0.7/Control.MiniMap.js"></script>
<script type="text/javascript"
	src="vendors/leaflet-0.7/leaflet.contextmenu.js"></script>
...
<script type="text/javascript"
	src="vendors/MarkerCluster/leaflet_markercluster-src.js"></script>
...
<script type="text/javascript"
	src="https://maps.google.com/maps/api/js?v=3&sensor=false"></script>
...
<link rel="stylesheet" type="text/css"
	href="resources/css/jquery-ui.multidatespicker.css">
<link rel="stylesheet" type="text/css"
	href="resources/css/bootstrap.css" />
<link rel="stylesheet" type="text/css"
	href="vendors/MarkerCluster/MarkerCluster.css" />
<link rel="stylesheet" type="text/css"
	href="vendors/MarkerCluster/MarkerCluster.styles.css" />
<link rel="stylesheet" type="text/css"
	href="vendors/MarkerCluster/MarkerCluster.Default.css" />
<link rel="stylesheet" type="text/css"
	href="vendors/leaflet-0.7/leaflet.draw.css" />
<link rel="stylesheet" type="text/css"
	href="vendors/leaflet-0.7/Control.MiniMap.css" />
<link rel="stylesheet" type="text/css"
	href="vendors/leaflet-0.7/leaflet.contextmenu.css" />
<link rel="stylesheet" type="text/css"
	href="vendors/DataTables/css/jquery.dataTables.css" />
<link rel="stylesheet" type="text/css"
	href="vendors/DataTables/css/dataTables.tableTools.css" />
<link rel="stylesheet" type="text/css"
	href="vendors/leaflet-0.7/leaflet.css" />
<link rel="stylesheet" type="text/css"
	href="vendors/leaflet-0.7/search/Control.Geocoder.css" />
...
<body style="display: none">
	...
	<div id="connectedAgencies-form"
		title="On-Map Connected Agencies Report" style="">
		<p style="font-size: 80%">
			Maximum Spatial Gap (miles) <input type="number" name="Sradius"
				id="Sradius" class="utbox" required min="0.1" value='0.1' step="0.1"
				onkeypress='return isNumber(event)' /> <input id="submit"
				type="button"
				onclick="reloadDialog2(document.getElementById('Sradius').value)"
				title="Click submit to refresh the report" value="Submit"
				class="button" />
		</p>
		<p>
			<br>
			<span>Agencies connected to: <b><br>- <span
					style="font-size: 80%; align: center;" id="dialogSelectedAgency"></span></b></span><br>
		<p id="displayConAgenciesTable"></p>
		<img id="dialogPreLoader2" src="../resources/images/287.GIF"
			alt="Page Loading" width="85" height="85" style="margin: 100px">
	</div>
	...
	<div id="dialog-form" title="On-Map Report">
		<div style="width: 100%; display: flex">
			<div style="width: 50%; margin-bottom: 13%; margin-top: 5.5%;">
				<p>
					<b>Centroid</b>:<br> <span style="padding-left: 3em">Latitude:
						<span style="padding-left: 1.5em" id="dialogLat"></span>
					</span><br> <span style="padding-left: 3em">Longitude: <span
						id="dialogLng"></span></span>
				</p>
				<br>
				<p>
					<b>Area</b>:<span id="dialogArea" style="padding-left: 1em"></span>
					Square Miles
				</p>
				<br>
				<p>
					<b>Date</b>: <input readonly type="text" id="dialogDate"
						style="width: 60%">
				</p>
				<input type="text" autofocus style="visibility: hidden">
			</div>
			<div style="width: 40%; margin-left: 10%; margin-bottom: 6%">
				<div id="blocksLengend"></div>
			</div>
		</div>
		...
		<div id="tabs">
			...
			<div id="transit">
				<b>Show Transit: </b><input type="radio" name="transitShow"
					id="stopsCheck" value="stops" style="margin-left: 2em"
					onclick="transitRadio(this)">Stops <input type="radio"
					name="transitShow" id="routeCheck" value="routes"
					style="margin-left: 1em" onclick="transitRadio(this)">Routes
				<input type="radio" name="transitShow" class="bothCheck"
					value="both" style="margin-left: 1em" checked
					onclick="transitRadio(this)">Both<br>
				<br>
				<table id="stopRoute"
					style="border: none; font-size: 100%; width: 90%">
					<tr>
			...
			<div id="geography">
				<b>Show Census: </b><input type="radio" name="censusShow"
					id="blocksCheck" value="blocks" style="margin-left: 2em"
					onclick="geoRadio(this)">Blocks <input type="radio"
					name="censusShow" id="tractsCheck" value="tracts"
					style="margin-left: 1em" onclick="geoRadio(this)">Tracts <input
					type="radio" name="censusShow" class="bothCheck" value="both"
					style="margin-left: 1em" checked onclick="geoRadio(this)">Both<br>
				<br>
				<table id="blockTract"
					style="border: none; font-size: 100%; width: 90%">
					<tr>
		...
		<img id="dialogPreLoader" src="../resources/images/287.GIF"
			alt="Page Loading" style="margin: 9em; margin-top: 22em">
	</div>
	<div id="dialogResults" title="Report Results"></div>
	<div id="map"></div>
