...
public final class ServiceCalendarDateExt extends IdentityBean<Integer> {
  ...
  public ServiceCalendarDateExt() {

  }

  public ServiceCalendarDateExt(ServiceCalendarDateExt obj) {
    this.id = obj.id;
