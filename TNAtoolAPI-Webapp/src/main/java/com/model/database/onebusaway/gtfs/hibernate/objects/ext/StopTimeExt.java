...
public final class StopTimeExt extends IdentityBean<Integer> implements
    Comparable<StopTimeExt>, StopTimeProxyExt {
  ...
  @CsvField(ignore = true)
  private transient StopTimeProxyExt proxy = null;

  public StopTimeExt() {

  }

  public StopTimeExt(StopTimeExt st) {
  ...
  public int compareTo(StopTimeExt o) {
   ...
   * @param proxy
   */
  public void setProxy(StopTimeProxyExt proxy) {
    this.proxy = proxy;
  }

  public StopTimeProxyExt getProxy() {
    return proxy;
  }
