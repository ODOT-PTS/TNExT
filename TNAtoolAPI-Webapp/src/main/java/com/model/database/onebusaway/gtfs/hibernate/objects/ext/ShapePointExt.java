...
public final class ShapePointExt extends IdentityBean<Integer> implements
    Comparable<ShapePointExt> {
  ...
  @CsvField(ignore = true)
  private transient ShapePointProxyExt proxy;

  public ShapePointExt() {

  }

  public ShapePointExt(ShapePointExt shapePoint) {
   ...
   * @param proxy
   */
  public void setProxy(ShapePointProxyExt proxy) {
    this.proxy = proxy;
  }

  public ShapePointProxyExt getProxy() {
    return proxy;
  }
  ...
  @Override
  public int compareTo(ShapePointExt o) {
